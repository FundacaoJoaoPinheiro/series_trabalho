\begin{table}[!htb]
    ...
    \fonte{Elaboração própria, com base nos dados da PNAD Contínua. Nota: a identificação é individual por estrato e indicador. Entre os candidatos que não rejeitam a hipótese de brancura dos resíduos pelo teste de Ljung-Box a 5\%, seleciona-se o mais parcimonioso, com desempate pelo BIC.}
