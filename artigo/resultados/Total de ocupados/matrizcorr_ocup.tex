...
\raisebox{0em}{\parbox[t]{2.8cm}{02 - Entorno e Colar \\[-2pt] Metropolitano de BH}} & 7,0885 & 0,2058 & 1 &  &  &  &  &  &  \\
...
\fonte{Elaboração própria, com base nos dados da PNAD Contínua. Nota: autovalores estimados de \(\Sigma_R\): 19,795; 7,915; 6,116; 4,066; 2,485; 1,281; 0,710 e 1 valor inferior a \(10^{-3}\). Posto numérico de 8 em 8; posto \textbf{efetivo} de 7, contando os autovalores que retêm ao menos 1\% do maior. As correlações devem, portanto, ser lidas em conjunto, e não isoladamente.}
\end{table}
