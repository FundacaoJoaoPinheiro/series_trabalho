...
f.estrutural_arma11<-function(y,i0){
  ...
  c_sinal_bsm_error <- matrix(c(1,0,1,0,1,0,0),1,7)
  c_seasonal_bsm_error <- matrix(c(0,0,1,0,1,0,0),1,7)
  ...
  # cria vetores indicadores para soma de estados
  c_sinal_bsm_error.sm <- matrix(c(1,0,1,0,1,0,0),1,7)
  c_seasonal_bsm_error.sm <- matrix(c(0,0,1,0,1,0,0),1,7)
