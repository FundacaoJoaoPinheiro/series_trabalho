...
legend("topleft", legend = c("Desocupação", "Sinal univariado - MA(1)","Sinal multivariado - MA(1)",
...
legend("topleft", legend = c("CV desocupados","CV sinal - univariado", "CV sinal - multivariado"), 
...
legend("topleft", legend = c("Desocupação", "Sinal univariado - ARMA(1,1)","Sinal multivariado - ARMA(1,1)",
                             "IC 95% - estimativa direta"),
       col = c("black","blue","red","black"),lty = c(1,1,1,2),lwd = c(2,2,2,1),bty = "n", cex=0.8)
