...
arquivos <- list.files("data/pnad8reg", pattern = "\\.RDS$", full.names = TRUE)
...
######################################
### Colar e Entorno Metropolitano de BH (linha: 2)
...
{par(mfrow=c(1,2),oma = c(2, 2, 3, 2))
  ...
  mtext("2 - Colar e entorno Metropolitano de BH", outer=TRUE, line =-2,cex=1.5,font=2)}
...
############################################################
### Norte de Minas (Linha: 6)
  # Agora inclui dados da RIDE
...
{par(mfrow=c(1,2),oma = c(2, 2, 3, 2))
  ...
  mtext("4 - Norte de Minas Gerais", outer=TRUE, line =-2,cex=1.5,font=2)}
...
### SALVANDO ARQUIVO LISTA #####################################################
 ...
 baseestr8reg<-list("01-Belo Horizonte"=bh,"02-Colar e Entorno metropolitano de BH"=entornobh,
